...
pub async fn trigger_visualization_transform_scan(
    ...
    let n_neighbors = viz_config
        .get("n_neighbors")
        .and_then(|v| v.as_i64())
        .unwrap_or(15) as i32;
    let n_components = viz_config
        .get("n_components")
        .and_then(|v| v.as_i64())
        .unwrap_or(2) as i32;
    let min_dist = viz_config
        .get("min_dist")
        .and_then(|v| v.as_f64())
        .unwrap_or(0.1) as f32;
    let metric = viz_config
        .get("metric")
        .and_then(|v| v.as_str())
        .unwrap_or("cosine")
        .to_string();
    let min_cluster_size = viz_config
        .get("min_cluster_size")
        .and_then(|v| v.as_i64())
        .unwrap_or(10) as i32;
    let min_samples = viz_config
        .get("min_samples")
        .and_then(|v| v.as_i64())
        .map(|v| v as i32);
    let topic_naming_llm_id = viz_config
