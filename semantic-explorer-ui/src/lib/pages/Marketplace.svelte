...
<div class="space-y-6 mx-auto">
	...
	<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4">
		<input
			...
			class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-600 dark:focus:ring-blue-400"
		/>
	</div>
